...
The `takeAccessibleScreenshot()` method bundles visual comparison and accessibility checking into a single call. It is documented in detail in the [Visual Comparisons (Diffs)](#visual-comparisons-diffs) section below.
