...
var accessible_screenshot_1 = require("./accessible-screenshot");
// See an implementation example at the bottom.
...
function defaultTestFunction(testCase, group) {
    var _this = this;
    return function (args, testInfo) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, args.page.goto(path)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, accessible_screenshot_1.takeAccessibleScreenshot)(args.page, testInfo, { fullPage: true })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
