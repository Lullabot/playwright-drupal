            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        // Wait for installation to complete, then set the right cookie in the
                        // browser so tests are routed correctly.
                                    ...
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            ...
                                            case 1:
                                                ...
                                                if (!(typeof process.env.DDEV_HOSTNAME !== 'undefined')) return [3 /*break*/, 3];
