...
function execDrushInTestSite(command) {
    return __awaiter(this, void 0, void 0, function () {
        var drush, exec, p;
        return __generator(this, function (_a) {
            drush = process.env.DDEV_HOSTNAME ? "./test/playwright/node_modules/playwright-drupal/bin/drush-playwright ".concat(drupal_test_id) : "ddev exec ./test/playwright/node_modules/playwright-drupal/bin/drush-playwright ".concat(drupal_test_id);
