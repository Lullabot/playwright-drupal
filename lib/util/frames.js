...
function waitForFrames(page) {
    return __awaiter(this, void 0, void 0, function () {
        var locators, _i, _a, l, frames, promises;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    l = _a[_i];
                    return [4 /*yield*/, l.evaluate(function (iframe) { return iframe.isConnected; })];
                case 4:
                ...
                case 7:
                    frames = page.frames();
                    promises = frames.map(function (frame) {
